...
namespace NWTradersWeb.Controllers
{
    public class CustomersController : Controller
    {
            ...
            string searchRegion = "")
        {
            ...
            IEnumerable<Customer> theCustomers = nwEntities. //this is all the data (all tables and all rows in each table)
                Customers. //all rows in the customers table
                OrderBy(c => c.CompanyName). //sort by company name
                Select(c => c) //select each customer (in the customers table)
